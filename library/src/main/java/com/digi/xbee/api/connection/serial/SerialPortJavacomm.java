...
/**
 * This class represents a serial port using the Javacomm library to communicate
 * with it.
 */
public class SerialPortJavacomm extends AbstractSerialPort implements SerialPortEventListener, CommPortOwnershipListener {
     ...
     *
     * @see #SerialPortJavacomm(String, int)
     * @see #SerialPortJavacomm(String, int, int)
     * @see #SerialPortJavacomm(String, SerialPortParameters, int)
     * @see SerialPortParameters
     */
    public SerialPortJavacomm(String port, SerialPortParameters parameters) {
     ...
     * @see #SerialPortJavacomm(String, int)
     * @see #SerialPortJavacomm(String, int, int)
     * @see #SerialPortJavacomm(String, SerialPortParameters)
     * @see SerialPortParameters
     */
    public SerialPortJavacomm(String port, SerialPortParameters parameters, int receiveTimeout) {
        super(port, parameters, receiveTimeout);
        this.logger = LoggerFactory.getLogger(SerialPortJavacomm.class);
    }
     ...
     * @see SerialPortParameters
     */
    public SerialPortJavacomm(String port, int baudRate) {
     ...
     * @see SerialPortParameters
     */
    public SerialPortJavacomm(String port, int baudRate, int receiveTimeout) {
    ...
    public void open() throws InterfaceInUseException, InvalidInterfaceException, InvalidConfigurationException, PermissionDeniedException {
        ...
        try {
            // Get the serial port.
            serialPort = (SerialPort) portIdentifier.open(PORT_ALIAS + " " + port, receiveTimeout);
            ...
            throw new InvalidInterfaceException(e.getMessage(), e);
        }
    }
